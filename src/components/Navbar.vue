...
<template>
  <Disclosure as="nav" class="bg-blue-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between h-16">
        ...
        <div class="flex gap-x-4">
          <div class="hidden sm:flex sm:gap-x-4">
            <!-- Current: "border-indigo-500 text-gray-900", Default: "border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700" -->
            <router-link to="/" active-class="border-indigo-500 text-gray-900" class="border-transparent text-blue-500 hover:border-blue-300 hover:text-blue-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
              Home
            </router-link>
            <router-link to="/kursus" active-class="border-indigo-500 text-blue-900" class="border-transparent text-blue-500 hover:border-blue-300 hover:text-blue-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
              Kursus
            </router-link>
            <router-link to="/blog" active-class="border-indigo-500 text-blue-900" class="border-transparent text-blue-500 hover:border-blue-300 hover:text-blue-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
              Blog
            </router-link>
            <router-link to="/hubungi-kami" active-class="border-indigo-500 text-blue-900" class="border-transparent text-blue-500 hover:border-blue-300 hover:text-blue-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
              Hubungi kami
            </router-link>
          </div>
          <!-- <div class="flex py-3">
            <router-link to="/register" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
              Daftar
            </router-link>
          </div> -->
        </div>
